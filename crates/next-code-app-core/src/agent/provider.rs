...
impl Agent {
    ...
    pub fn model_catalog_snapshot(&self) -> next_code_provider_core::ModelCatalogSnapshot {
    ...
    pub fn active_resolved_credential(&self) -> Option<next_code_provider_core::ResolvedCredential> {
