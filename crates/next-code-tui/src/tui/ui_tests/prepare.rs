...
fn test_prepare_messages_renders_reasoning_role_dim_italic_without_sentinel() {
    ...
    content.push_str(&next_code_tui_markdown::reasoning_line_markup(
...
fn test_prepare_messages_renders_anchored_reasoning_message_in_flow() {
    ...
    trace.push_str(&next_code_tui_markdown::reasoning_line_markup(
        "anchored thinking",
    ));
    ...
    assert!(
        !joined[reasoning_idx].contains(next_code_tui_markdown::REASONING_SENTINEL),
