...
fn benchmark_real_resume_loading_phases() {
    ...
    let next_code_summary_elapsed = phase_start.elapsed();
    ...
    eprintln!(
        concat!(
            ...
            "next_code_summary={}ms next_code_loaded={} skipped_empty={} skipped_imported={} summary_errors={} ",
        ...
        next_code_summary_elapsed.as_millis(),
        sessions.len(),
        skipped_empty,
        skipped_imported,
        summary_errors,
