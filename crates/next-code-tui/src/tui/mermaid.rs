...
pub use next_code_tui_mermaid::{ImageScrollBenchmark, cache_stat_syscalls};
...
pub fn install_jcode_mermaid_hooks() {
    ...
    next_code_tui_mermaid::set_memory_snapshot_hook(|| {
        let snapshot = crate::process_memory::snapshot_with_source("client:mermaid:memory");
        next_code_tui_mermaid::ProcessMemorySnapshot {
