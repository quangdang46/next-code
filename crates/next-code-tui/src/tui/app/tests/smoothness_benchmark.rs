...
fn observe_smoothness_frame(
    ...
    recorder: &mut next_code_tui_core::anchor_stability::AnchorStabilityRecorder,
) {
    terminal
...
fn smoothness_benchmark_simulated_streaming_turn_stays_within_budget() {
    ...
    let mut recorder = next_code_tui_core::anchor_stability::AnchorStabilityRecorder::new();
