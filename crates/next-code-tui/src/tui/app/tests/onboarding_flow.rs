    ...
    fn model_routes(&self) -> Vec<crate::provider::ModelRoute> {
        vec![
            crate::provider::ModelRoute {
                model: next_code_provider_core::DEFAULT_CLAUDE_MODEL.to_string(),
            ...
            crate::provider::ModelRoute {
                model: next_code_provider_core::DEFAULT_OPENAI_MODEL.to_string(),
                provider: "OpenAI".to_string(),
                api_method: "openai-api-key".to_string(),
                available: true,
                detail: String::new(),
...
fn import_continue_reaches_ready_quality_first_openai_model() {
    ...
    with_temp_next_code_home(|| {
        ...
        runtime.block_on(async {
            ...
            assert_eq!(model, next_code_provider_core::DEFAULT_OPENAI_MODEL);
