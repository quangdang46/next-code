...
/// (see `next_code_tui_markdown::reasoning_line_markup`). Trailing blank lines left
...
impl App {
    ...
    pub(super) fn append_reasoning_text(&mut self, text: &str) {
        ...
        for ch in text.chars() {
            if ch == '\n' {
                ...
                committed.push_str(&next_code_tui_markdown::reasoning_line_markup(&line));
            } else {
        ...
        let partial = next_code_tui_markdown::reasoning_partial_markup(&self.reasoning_pending_line);
    ...
    pub(super) fn close_reasoning_region(&mut self, _footer: Option<String>) {
        ...
        if !pending.is_empty() {
            self.streaming
                .streaming_text
                .push_str(&next_code_tui_markdown::reasoning_line_markup(&pending));
        }
    ...
    pub(super) fn submit_input(&mut self) {
        ...
        let handled = commands::handle_help_command(self, trimmed)
            ...
            || commands::handle_theme_command(self, trimmed)
