...
impl App {
    ...
    pub(super) fn new_minimal_with_session(
        ...
        let mut app = Self {
            ...
            registry,
            skills,
            at_picker: at_picker::AtPickerSlot::Pending,
            mcp_manager,
            messages: Vec::new(),
            session,
            ...
            pending_permission_session_id: None,
            pending_permission_code: None,
            pending_permission_alternatives: Vec::new(),
            pending_permission_selected: 0,
            pending_permission_input: None,
            pending_permission_finding: None,
            pending_permission_at: None,
            viewing_teammate_session_id: None,
            teammate_view_agent_name: None,
            teammate_view_messages: Vec::new(),
            teammate_view_return_session_id: None,
            teammate_view_hard_attached: false,
            teammate_view_swarm_snapshot: Vec::new(),
            teammate_transcripts: std::collections::HashMap::new(),
            teammate_view_abort_armed: false,
            view_teammate_selection: false,
            agent_tree_selecting: false,
            selected_agent_tree_index: -1,
            agent_tree_hidden: false,
            goal_continuation_disabled: false,
            agent_snapshot_cache: Vec::new(),
            agent_snapshot_checked: false,
    ...
    pub fn new(provider: Arc<dyn Provider>, registry: Registry) -> Self {
        ...
        // so a new client session never inherits mode state from a prior run.
        {
            ...
            next_code_keywords::clear_modes_if_session_start(
                kw_cfg.enabled,
    ...
    fn restore_remote_startup_history(&mut self, session_id: &str) {
        ...
        let display_messages =
            next_code_tui_messages::display_messages_from_rendered_messages(rendered_messages);
