...
use next_code_plugin_core::events::{EventInput, HandlerAction, HandlerResult};
use next_code_plugin_core::types::PluginId;
use next_code_plugin_core::{CapabilityChainV2, PluginEvent, ToolTier};
...
fn test_preflight_clean_passes() {
    use next_code_plugin_core::manifest::PluginCapabilities;
...
fn test_audit_trail_ring_buffer() {
    ...
    use next_code_plugin_core::PluginId;
