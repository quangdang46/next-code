...
//! keychain via [`next_code_keyring_store::KeyringStore`]. The on-disk format
...
/// [`next_code_keyring_store::DefaultKeyringStore`] in production and
/// [`next_code_keyring_store::MockKeyringStore`] in tests).
