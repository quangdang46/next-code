...
use next_code_llm_core::framing::{Framing, SseFrame};
use next_code_llm_core::protocol::{Protocol, StepOutput};
use next_code_llm_core::route::PreparedRoute;
use next_code_llm_core::schema::{ContentPart, LlmRequest, ToolChoice, Usage};
...
fn extract_usage(response: &Value) -> Option<Usage> {
    ...
    Some(Usage {
        ...
        total_tokens,
        breakdown: reasoning_tokens.map(|rt| next_code_llm_core::schema::UsageBreakdown {
...
pub fn responses_route() -> PreparedRoute {
    ...
    PreparedRoute {
        ...
        provider: next_code_llm_core::schema::ModelRef {
