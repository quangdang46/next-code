//! Vendored near-verbatim from upstream `xai-grok-shell::auth::meta`
//! (~40 lines, no upstream logic to strip — small enough to keep faithful
//! rather than resimplify).
...
pub struct AuthMeta {
    ...
    #[serde(default = "super::default_coding_data_retention_opt_out")]
...
impl Default for AuthMeta {
    fn default() -> Self {
        Self {
            ...
            is_zdr: false,
            team_role: None,
            coding_data_retention_opt_out: super::default_coding_data_retention_opt_out(),
