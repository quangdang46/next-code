...
/// Mirrors `next_code_plan::dag::NodeSpec` but kept as an explicit wire type so the
...
pub enum Request {
    ...
    Reload {
        ...
        /// `next-code server reload` can request a graceful upgrade without risking
    ...
    SetRoute {
        id: u64,
        selection: next_code_provider_core::RouteSelection,
    },
    ...
    SetCompactionMode {
        id: u64,
        mode: next_code_config_types::CompactionMode,
    },
    ...
    /// Send a task to next-code agent
    ...
    /// Query next-code agent's capabilities
...
pub enum ServerEvent {
    ...
    SidePaneImages {
        session_id: String,
        images: Vec<next_code_session_types::RenderedImage>,
    },
    ...
    History {
        ...
        #[serde(default, skip_serializing_if = "Vec::is_empty")]
        available_model_routes: Vec<next_code_provider_core::ModelRoute>,
        ...
        #[serde(default, skip_serializing_if = "Option::is_none")]
        resolved_credential: Option<next_code_provider_core::ResolvedCredential>,
        ...
        #[serde(default)]
        compaction_mode: next_code_config_types::CompactionMode,
    ...
    CommListModelsResponse {
        ...
        #[serde(default, skip_serializing_if = "Vec::is_empty")]
        model_routes: Vec<next_code_provider_core::ModelRoute>,
    },
