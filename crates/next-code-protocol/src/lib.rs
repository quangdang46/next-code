...
use next_code_batch_types::BatchProgress;
use next_code_message_types::{InputShellResult, ToolCall};
use next_code_plan::{PlanItem, VersionedPlan, next_runnable_item_ids, summarize_plan_graph};
use next_code_side_panel_types::{SidePanelSnapshot, snapshot_is_empty};
...
pub type ReloadRecoverySnapshot = next_code_selfdev_types::ReloadRecoveryDirective;
...
impl PlanGraphStatus {
    ...
    pub fn from_versioned_plan(
        ...
        let growth = next_code_plan::bridge::growth_stats(plan);
        ...
        Self {
            ...
            newly_ready_ids,
            low_confidence_ids: next_code_plan::bridge::low_confidence_completed_ids(plan),
...
impl Request {
    pub fn id(&self) -> u64 {
        match self {
            ...
            Request::ExitPlanModeResponse { id, .. } => *id,
