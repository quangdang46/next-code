...
impl ActionId {
    ...
    pub fn binding_name(self) -> &'static str {
        match self {
            ...
            ActionId::ToggleTeamTasks => "toggle_team_tasks",
            ActionId::AgentPanelSelectPrev => "agent_panel_select_prev",
            ActionId::AgentPanelSelectNext => "agent_panel_select_next",
            ActionId::TeamTaskSelectPrev => "team_task_select_prev",
            ActionId::TeamTaskSelectNext => "team_task_select_next",
            ...
            ActionId::ToggleThinkingEffort => "toggle_thinking_effort",
