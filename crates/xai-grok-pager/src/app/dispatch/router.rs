...
use super::settings::setters::{
    ...
    set_remember_tool_approvals, set_render_mermaid, set_render_mermaid_target,
    set_respect_manual_folds, set_side_panel_output_mode,
    set_side_panel_width, set_screen_mode,
...
pub(crate) fn dispatch(action: Action, app: &mut AppView) -> Vec<Effect> {
    ...
    let effects = match action {
        ...
        Action::SetSidePanelOutputMode(s) => set_side_panel_output_mode(app, s),
        Action::SetSidePanelWidth(w) => set_side_panel_width(app, w),
        ...
        Action::SetRenderMermaidTarget(s) => set_render_mermaid_target(app, s),
        ...
        Action::SetStatusLineOrder(v) => set_status_line_order(app, v),
        Action::ToggleStatusLineSegment(seg) => toggle_status_line_segment(app, seg),
        Action::ResetStatusLine => reset_status_line(app),
