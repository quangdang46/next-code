...
mod tests {
    ...
    // On a non-legacy console the helpers must return the fancy glyphs.
    // Cursor/CI shells on Windows often report legacy — skip there.
    #[test]
    ...
    // On a non-legacy console the funnel must be a zero-copy borrow.
    #[test]
