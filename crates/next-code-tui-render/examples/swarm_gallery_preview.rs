...
//!
//! Run with: `cargo run --profile selfdev -p next-code-tui-render --example swarm_gallery_preview`
...
use next_code_tui_render::swarm_tiles::{SwarmGalleryConfig, SwarmTile, render_swarm_gallery};
use ratatui::prelude::*;
