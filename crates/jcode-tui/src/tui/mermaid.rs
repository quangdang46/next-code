pub use jcode_tui_mermaid::{
    ...
    inline_image_id, invalidate_render_state, is_mermaid_lang, is_video_export_mode,
    materialize_inline_image, normalize_aspect_ratio, parse_image_placeholder,
    preferred_aspect_ratio_bucket, protocol_type, register_active_diagram, register_external_image,
    register_inline_image, render_image_widget, render_image_widget_fit, render_image_widget_scale,
    render_image_widget_viewport, render_image_widget_viewport_precise, render_mermaid,
