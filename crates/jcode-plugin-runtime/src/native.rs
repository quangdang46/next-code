...
use jcode_plugin_core::security::{AccessDecision, CapabilityAction, CapabilityChain};
...
impl NativeBindings {
    ...
    pub async fn http_post(chain: &CapabilityChain, url: &str, body: &str) -> Result<String, PluginError> {
        Self::require_capability(chain, url, &CapabilityAction::Network)?;
    ...
    pub async fn fs_write_text(chain: &CapabilityChain, path: &str, content: &str) -> Result<(), PluginError> {
