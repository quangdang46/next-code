...
impl From<AnthropicCredentialMode> for jcode_provider_core::CredentialMode {
    fn from(m: AnthropicCredentialMode) -> Self {
        match m {
            AnthropicCredentialMode::Auto => Self::Auto,
            AnthropicCredentialMode::OAuth => Self::OAuth,
            AnthropicCredentialMode::ApiKey => Self::ApiKey,
        }
    }
}

impl From<jcode_provider_core::CredentialMode> for AnthropicCredentialMode {
