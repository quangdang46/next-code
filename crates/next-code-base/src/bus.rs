...
pub use next_code_batch_types::{BatchProgress, BatchSubcallProgress, BatchSubcallState};
...
pub struct ModelRefreshCompleted {
    pub session_id: String,
    pub result: std::result::Result<next_code_provider_core::ModelCatalogRefreshSummary, String>,
}
...
pub enum BusEvent {
    ...
    UsageReport(Vec<next_code_usage_types::ProviderUsage>),
    /// Progressive usage report update while providers are still loading
    UsageReportProgress(next_code_usage_types::ProviderUsageProgress),
