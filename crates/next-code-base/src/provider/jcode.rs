...
impl NextCodeProvider {
    ...
    fn apply_runtime_profile() {
        let _ = crate::provider::activation::ProviderActivation::next_code_subscription(
...
mod tests {
    ...
    #[test]
    fn next_code_provider_enables_subscription_runtime_mode() {
    ...
    #[test]
    fn next_code_provider_name_and_default_model_are_curated() {
        let _guard = crate::storage::lock_test_env();
        crate::subscription_catalog::clear_runtime_env();
        let runtime = tokio::runtime::Runtime::new().expect("tokio runtime");
