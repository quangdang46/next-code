pub use next_code_provider_openai::{
...
use next_code_provider_openai::OpenAiRequestLogLevel;
use serde_json::Value;

pub fn build_responses_input(messages: &[ChatMessage]) -> Vec<Value> {
    next_code_provider_openai::build_responses_input_with_logger(messages, |level, message| match level
    {
