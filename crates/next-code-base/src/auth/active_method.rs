...
impl From<next_code_provider_core::ResolvedCredential> for ActiveCredential {
    fn from(value: next_code_provider_core::ResolvedCredential) -> Self {
        match value {
            next_code_provider_core::ResolvedCredential::Oauth => Self::OAuth,
            next_code_provider_core::ResolvedCredential::ApiKey => Self::ApiKey,
        }
    }
}
...
pub fn resolve_dual_credential_auth(
    ...
    let dual = next_code_provider_core::DualAuthProvider::from_active_provider(provider)?;
    ...
    let forced =
        next_code_provider_core::pinned_mode_for(dual, runtime_provider).map(|mode| match mode {
            next_code_provider_core::AuthMode::Oauth => ActiveCredential::OAuth,
            next_code_provider_core::AuthMode::ApiKey => ActiveCredential::ApiKey,
        });
