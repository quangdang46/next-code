...
pub fn get_syntect() -> &'static Syntect {
    match crate::theme::Theme::current_kind() {
        ...
        | ThemeKind::Auto => SYNTECT_GROKNIGHT
            .get_or_init(|| Syntect::new("grok-night", Some(Path::new("assets/grok-night.tmTheme")))),
        ThemeKind::TokyoNight => SYNTECT_TOKYONIGHT
            .get_or_init(|| Syntect::new("tokyo-night", Some(Path::new("assets/tokyo-night.tmTheme")))),
        ThemeKind::GrokDay => SYNTECT_GROKDAY
            .get_or_init(|| Syntect::new("grok-day", Some(Path::new("assets/grok-day.tmTheme")))),
    }
}
