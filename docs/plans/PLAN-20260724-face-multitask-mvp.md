...
- **Status:** Phase 1 **Implemented** on `feat/face-cursor-multitask` (Face `/multitask` + CommSpawn headless + agent-team steer).
...
| 1 Multitask MVP | **M** | **Implemented** (Face `/multitask`) |
