...
description: >
  ...
  that implies implementing/improving a capability. This skill clones 13 reference repos, spawns
...
Comprehensive feature research + implementation planning using 13 reference repos as the knowledge base.
...
| `crush` | https://github.com/charmbracelet/crush | Go / Charm ecosystem | Go-based TUI agent with Bubble Tea, session workspaces, shared multi-client sessions, MCP + LSP integration, Agent Skills standard, auto-provider updates |
...
Run sub-agents in parallel. Collect all 13 reports before continuing.
...
for repo in \
  ...
  "https://github.com/charmbracelet/crush"; do
...
> Generated from research across 13 repos + user interview
...
See `references/repo-summaries.md` for static summaries of all 13 repos (useful when cloning is slow or unavailable).