...
SESSION_ID="${NEXT_CODE_MEMGATE_SESSION:-session_hog_1783086065415_4ad4ae66cd43dd5b}"
IDLE_SECS=60
MAX_RSS_ANON_KB="${NEXT_CODE_MEMGATE_MAX_RSS_ANON_KB:-56320}"
MAX_LIVE_HEAP_BYTES="${NEXT_CODE_MEMGATE_MAX_LIVE_HEAP_BYTES:-47185920}"
