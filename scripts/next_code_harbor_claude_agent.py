...
DEFAULT_BINARY_PATH = "/tmp/next-code-compat-dist/next-code-linux-x86_64.bin"
DEFAULT_CLAUDE_AUTH_PATH = "~/.next-code/auth.json"
...
NEXT_CODE_BINARY = _resolve_existing_file(
    ...
    for lib in (
        _resolve_optional_existing_file(
            candidates=(
                ...
                *_sibling_runtime_lib_candidates(NEXT_CODE_BINARY, "libssl"),
                "/usr/lib/libssl.so.3",
        ...
        _resolve_optional_existing_file(
            candidates=(
                ...
                *_sibling_runtime_lib_candidates(NEXT_CODE_BINARY, "libcrypto"),
...
class NextCodeClaudeHarborAgent(BaseAgent):
    ...
    def __init__(self, logs_dir: Path, model_name: str | None = None, *args, **kwargs):
        ...
        if "/" in self._model_arg:
            self._provider_arg, self._next_code_model = self._model_arg.split("/", 1)
        else:
            self._provider_arg, self._next_code_model = "anthropic-api", self._model_arg
    ...
    async def setup(self, environment: BaseEnvironment) -> None:
        ...
        await environment.upload_file(NEXT_CODE_BINARY, IN_CONTAINER_BINARY)
    ...
    async def run(self, instruction: str, environment: BaseEnvironment, context: AgentContext) -> None:
        ...
        env = {
            ...
            "NEXT_CODE_MODEL": self._next_code_model,
        ...
        metadata: dict[str, Any] = {
            ...
            "model": self._next_code_model,
            "next_code_binary": str(NEXT_CODE_BINARY),
        }
