...
#
# Env:
#   NEXT_CODE_DESKTOP_BIN              binary (default target/debug/next-code-desktop)
#   NEXT_CODE_JOURNEY_TIMEOUT_SECS     per-wait timeout (default 15)
#   NEXT_CODE_JOURNEY_GAP_BUDGET_MS    max acceptable no-paint gap (default 1000)
#   NEXT_CODE_JOURNEY_SCREENSHOT_DIR   if set, save a grim screenshot per step
#
...
TIMEOUT_SECS="${NEXT_CODE_JOURNEY_TIMEOUT_SECS:-${NEXT_CODE_JOURNEY_TIMEOUT_SECS:-15}}"
GAP_BUDGET_MS="${NEXT_CODE_JOURNEY_GAP_BUDGET_MS:-${NEXT_CODE_JOURNEY_GAP_BUDGET_MS:-1000}}"
SCREENSHOT_DIR="${NEXT_CODE_JOURNEY_SCREENSHOT_DIR:-${NEXT_CODE_JOURNEY_SCREENSHOT_DIR:-}}"
