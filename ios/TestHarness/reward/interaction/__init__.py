"""Interaction-cost engine: a graph-based, HCI-grounded model of next-code-mobile use.
...
disjoint modules in this package against that contract:
  ...
  log_mining.py   mine ~/.next-code/logs to ground edge weights in REAL TUI usage
